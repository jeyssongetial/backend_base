...
public class BusinessException extends ApplicationException {
    ...
    public enum Type {
        ...
        ERROR_TAREA_NO_ENCONTRADA(new Error(CodigosErrorNegocio.NEGOCIO_2, TipoError.NEGOCIO, "Tarea no encontrada", "No se encontró la tarea con el ID proporcionado")),;
